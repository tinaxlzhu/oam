...
/**
 * RouteDataSync_Head bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class RouteDataSync_Head implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * RouteDataSync_Head Namespace URI = http://tempuri.org/NS1.xsd Namespace
	 * Prefix = ns2
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":RouteDataSync_Head", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"RouteDataSync_Head", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static RouteDataSync_Head parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			RouteDataSync_Head object = new RouteDataSync_Head();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"RouteDataSync_Head".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (RouteDataSync_Head) org.tempuri.ns1_xsd.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "MSGTYPE")
					...
					if (!"true".equals(nillableValue)
						...
						object.setMSGTYPE(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object.setRECORDTYPE(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
	...
	public String toString() {
		return "RouteDataSync_Head [localMSGTYPE=" + localMSGTYPE
				+ ", localRECORDTYPE=" + localRECORDTYPE + ", localVERSION="
				+ localVERSION + "]";
	}
