...
public class String implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://schemas.xmlsoap.org/soap/encoding/", "string", "ns1");
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		localString.serialize(MY_QNAME, xmlWriter);
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
							...
							object.setString(org.apache.axis2.databinding.types.soapencoding.String.Factory
									.parse(reader));
