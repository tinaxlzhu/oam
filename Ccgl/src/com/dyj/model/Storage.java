...
public class Storage {
	...
	private int storagenumberold;

	private String storageunit;

	public int getStoragenumberold() {
		return storagenumberold;
	}

	public void setStoragenumberold(int storagenumberold) {
		this.storagenumberold = storagenumberold;
	}
