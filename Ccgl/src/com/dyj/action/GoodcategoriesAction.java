...
public class GoodcategoriesAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		try {
			...
			JSONArray jsonArray = JsonUtil
					.formatRsToJsonArray(goodcategoriesdao.goodcategoriesList(
							con, pageBean, goodcategories));
			int total = goodcategoriesdao.goodcategoriesCount(con,
					goodcategories);
	...
	public String save() throws Exception {
		...
		try {
			...
			JSONObject result = new JSONObject();
			if (StringUtil.isNotEmpty(id)) {
				saveNums = goodcategoriesdao.goodcategoriesModify(con,
						goodcategories);
			} else {
				saveNums = goodcategoriesdao.goodcategoriesAdd(con,
						goodcategories);
			}
			if (saveNums > 0) {
				result.put("success", "true");
	...
	public String export() throws Exception {
		...
		try {
			...
			goodcategories.setGoodname(g_name);
			ResultSet rs = goodcategoriesdao.goodcategoriesList(con, null,
					goodcategories);
