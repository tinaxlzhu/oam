...
public class SupplierAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		try {
			...
			JSONArray jsonArray = JsonUtil.formatRsToJsonArray(supplierdao
					.supplierList(con, pageBean, supplier));
	...
	public String gradeComboList() throws Exception {
		...
		try {
			...
			jsonArray.addAll(JsonUtil.formatRsToJsonArray(supplierdao
					.supplierList(con, null, null)));
