...
public class StorageAction extends ActionSupport implements ServletRequestAware {
	...
	public String execute() throws Exception {
		...
		try {
			...
			JSONArray jsonArray = JsonUtil.formatRsToJsonArray(storagedao
					.storageList(con, pageBean, storage));
	...
	public String upload() throws Exception {
		...
		if (hssfSheet != null) {
			for (int rowNum = 1; rowNum <= hssfSheet.getLastRowNum(); rowNum++) {
				...
				storage.setGoodid(Integer.parseInt(FormatStringUtil
						.formatString(Conversiongood.conversion(ExcelUtil
								.formatCell(hssfRow.getCell(0))))));
				storage.setInprice(Integer.parseInt(FormatStringUtil
						.formatString(ExcelUtil.formatCell(hssfRow.getCell(1)))));
				storage.setStoragedate(DateUtil.formatString(hssfRow.getCell(2)
						.getStringCellValue(), "yyyy-MM-dd"));
				storage.setStoragenumber(Integer.parseInt((FormatStringUtil
						.formatString(ExcelUtil.formatCell(hssfRow.getCell(3))))));
				storage.setStoragenote((FormatStringUtil.formatString(ExcelUtil
