...
//			good.setPhoto(rs.getString("photo"));
	...
	public String count(Connection con)throws Exception{
		...
		public ResultSet goodList(Connection con,PageBean pageBean,Good good)throws Exception{
			StringBuffer sb=new StringBuffer("select g.id id,g.goodname goodname,concat(gc.goodname,'(',g.goodcategoriesid,')') goodcategoriesid,g.note from t_good g left join t_goodcategories gc on g.goodcategoriesid = gc.id ");
