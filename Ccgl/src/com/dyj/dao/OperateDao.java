...
public class OperateDao {
	...
	public ResultSet operateList(Connection con,PageBean pageBean,Operate operate)throws Exception{
	...
	public int operateCount(Connection con,Operate operate)throws Exception{
		StringBuffer sb=new StringBuffer("select count(*) as total from t_operate,t_good where t_operate.goodid=t_good.id");
	...
	public int operateAdd(Connection con,Operate operate)throws Exception {
		...
		String sql="INSERT INTO t_operate (id,userid,operatetime,operateType,remark,goodid) values(null,?,?,?,?,?)";
		PreparedStatement pstmt=con.prepareStatement(sql);
		pstmt.setInt(1, operate.getUserid());
		pstmt.setString(2, DateUtil.formatDate(operate.getOperatetime(),"yyyy-MM-dd"));
